...
CREATE TABLE pairwise_compatibility_status (install_name_lower VARCHAR(200), install_name_higher VARCHAR(200), status VARCHAR(20), py_version VARCHAR(5), timestamp TIMESTAMP, details VARCHAR(5000), PRIMARY KEY (install_name_lower, install_name_higher, py_version));
